...
<nav id="navbar" class="bg-white shadow py-3">
    <div class="px-3 px-md-5 d-flex justify-content-between align-items-center">
        ...
        <div class="nav-menu py-5 py-lg-0">
            ...
            <a href="./faq.php" class="nav-link2 py-3 nav-links link nav-color text-uppercase font-weight-500">
                <span>Faq</span>
            </a>
